...
class Alertable extends StatefulWidget {
  ...
  const Alertable({Key? key, required this.message,required this.introduction}) : super(key: key);
...
class _AlertableState extends State<Alertable> {
  ...
  void _createNewEntry() {
    ...
    if (renderObject != null && renderObject is RenderBox) {
      ...
      Offset offset = Offset(targetSize.width/2-boxWidth/2,targetSize.height+marginTop);
